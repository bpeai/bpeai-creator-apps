...
4. **Identity** — `py/apps/<id>/` + matching `manifest.json` / class / **same-named** pack (`py/knowledge/<id>/`).
5. **Pack** — private pack prompts + catalogs + outlines; optional SME PDFs in `references/content/`.
