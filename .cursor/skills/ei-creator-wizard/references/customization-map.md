...
| Creator PDF/docs | Pack `references/content/` (indexed; sizing bootstrap drafts methods/assumptions/basis) | — | Replacing web search with pack files only; `.docx` (not indexed) |
